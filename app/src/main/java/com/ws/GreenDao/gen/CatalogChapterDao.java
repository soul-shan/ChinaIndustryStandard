...
/** 
 * DAO for table "CATALOG_CHAPTER".
*/
public class CatalogChapterDao extends AbstractDao<CatalogChapter, Void> {

    public static final String TABLENAME = "CATALOG_CHAPTER";

    /**
     * Properties of entity CatalogChapter.<br/>
    ...
    public CatalogChapterDao(DaoConfig config) {
        super(config);
    }
    
    public CatalogChapterDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CATALOG_CHAPTER\" (" + //
                "\"ID\" INTEGER," + // 0: id
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CATALOG_CHAPTER\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CatalogChapter entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CatalogChapter entity) {
        stmt.clearBindings();
    ...
    @Override
    public CatalogChapter readEntity(Cursor cursor, int offset) {
        CatalogChapter entity = new CatalogChapter( //
    ...
    @Override
    public void readEntity(Cursor cursor, CatalogChapter entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(CatalogChapter entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(CatalogChapter entity) {
        return null;
    }

    @Override
    public boolean hasKey(CatalogChapter entity) {
        // TODO
        return false;
    }
